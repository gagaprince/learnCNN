...
def conv1x1(input_chanels, output_chanels, stride=1, padding=1):
    return nn.Conv2d(input_chanels, output_chanels, kernel_size=1, stride=stride, padding=1)
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, input_chanels, output_chanels, stride=1, downsample=None, norm_Layer=None):
        ...
        self.conv1 = conv3x3(input_chanels, output_chanels, stride)
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classses=100, norm_layer=None):
        ...
        self.avgpool = nn.AdaptiveAvgPool1d2d((1, 1))
    ...
    def _make_layer(self, block, output_chanels, blocks, stride=1):
        ...
        if stride != 1 or self.input_chanels != output_chanels * block.expansion:
            downsample = nn.Sequential(
                conv1x1(self.input_chanels, output_chanels * block.expansion, stride),
